...
<div class="container mx-auto">
   <div class="px-3 mx-auto my-10 leading-7 text-justify text-gray-700 lg:text-left lg:px-20">
    ...
    <ul class="pl-6 list-disc list-outside">
      ...
      <li>
        <strong>Website</strong> refers to Allridey.com.au, accessible
        from
        <router-link :to="{ name: 'Home'}" class="text-blue-500 break-all hover:underline">https://www.allridey.com.au</router-link>
      </li>
      <li>
    ...
    <ul class="pl-6 list-disc list-outside">
      <li class="break-all">
        By email: sales@allridey.com.au
      </li>
    </ul>
  </div>
</div>
