<template>
  <div class="container mx-auto">
    <div
      class="px-3 mx-auto my-10 leading-7 text-justify text-gray-700 lg:text-left lg:px-20"
    >
      ...
      <p>
        ...
        website or Service and tells You about Your privacy rights and how the
        law protects You.
      </p>
      <p>
        We use Your Personal data to provide and improve the Service. By using
        the website or Service, You agree to the collection and use of
      ...
      <ul class="pl-6 list-disc list-outside">
        ...
        <li>
          ...
          this Agreement) refers to Allridey Pty Ltd.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to Allridey.com.au, accessible from
          <router-link
            :to="{ name: 'Home' }"
            class="text-blue-500 break-all hover:underline"
            >https://www.allridey.com.au</router-link
          >
        </li>
        <li>
      ...
      <ul class="pl-6 list-disc list-outside">
        ...
        <li>
          ...
          <p>
            ...
            You use the Website, such as remembering your form data or language
      ...
      <ul class="pl-6 list-disc list-outside">
        ...
        <li>
          <p>
            ...
            Service. The Personal Data You provide is used to facilitate usage
      ...
      <ul class="pl-6 list-disc list-outside">
        ...
        <li>
          ...
          reviews, such information may be viewed by all users and may be
      ...
      <ul class="pl-6 list-disc list-outside">
        <li class="break-all">By email: sales@allridey.com.au</li>
      </ul>
    </div>
  </div>
</template>
