    ...
    watch: {
      ...
      confirmedPayment: {
        ...
        trackPayment() {
          let items = [
            ...
            },
            {
              ...
              price:
                this.bookinginfo.bookinginfo[0].kmcharges_totalfordailyrate,
              quantity: 1,
            },
          ]
          ...
          this.$gtag.event('purchase', {
            ...
            transaction_id:
              this.bookinginfo.bookinginfo[0].reservationdocumentno,
            value: this.bookinginfo.bookinginfo[0].totalcost,
            items: items,
            coupon: this.bookinginfo.rateinfo[0].discountname.replaceAll(
              ' ',
              '_'
            ),
          })
        ...
        requestWindcaveTransaction() {
          let balancedue =
            this.$store.state.bookinginfo.bookinginfo[0].balancedue
          let currency =
            this.$store.state.bookinginfo.bookinginfo[0].currencyname
          let resref =
            this.$store.state.bookinginfo.bookinginfo[0].reservationref
          if (balancedue > 0) {
