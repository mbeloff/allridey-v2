<template>
  <div class="text-left p-2">
    <div v-if="booking.isquotation" class="rounded bg-opacity-90 w-full p-1 flex flex-col gap-3">
      <div class="flex flex-col md:flex-row gap-3 items-start">
        ...
        <div class="flex flex-col shadow-xl bg-gray-200 p-2 gap-2 py-10">
        ...
        <a :href="booking.quoteconversionurl" class="bg-green-500 px-4 py-1 mx-auto my-5">Convert to Booking</a>
        </div>
      </div>
    </div>
  </div>
